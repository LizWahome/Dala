...
mixin InputValidationMixin {
  ...
  ValidateFailResult? isInvalidIdNumber(String? value) {
    String? isValidIdNumber = value?.replaceAll(isNumber, '');

    if (isValidIdNumber != null) {
      if (isValidIdNumber.length < 8 || isValidIdNumber.length > 8) {
        return ValidateFailResult.invalidIdNumber;
      }
    }
